...
export interface AutomationPayload {
  ...
  /**
   * Deduplicated, lowercase kebab-case tags computed server-side.
   * Sent to GHL so workflows can branch without re-evaluating form data.
   * Generated by `buildLeadTags()` in `lib/service-request/tags.ts`.
   */
  tags: string[];
}
