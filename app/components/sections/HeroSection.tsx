...
export function HeroSection({ company }: HeroSectionProps) {
  return (
    <section
      className="relative flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-28 text-white text-center"
    ...
    >
      ...
      >
        {company.city}, TX &nbsp;&middot;&nbsp; Licensed &amp; Insured
      </p>
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 bg-black/30 backdrop-blur-sm rounded px-6 py-4">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-white/90 text-sm font-semibold">
            4.9 <span className="text-white/55 font-normal">(320 reviews)</span>
          </span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-white/90 text-sm font-semibold">
            4.8 <span className="text-white/55 font-normal">(180 reviews)</span>
          </span>
        </div>
      </div>
    </section>
