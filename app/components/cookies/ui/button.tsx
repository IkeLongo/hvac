...
export function Button({
  ...
  const solid =
    "text-white hover:opacity-95 focus-visible:ring-white ring-offset-slate-950";
  ...
  const solidStyle: React.CSSProperties =
    variant === "solid"
      ? { backgroundColor: "var(--cookie-accent)", color: "var(--cookie-primary)" }
      : {};
