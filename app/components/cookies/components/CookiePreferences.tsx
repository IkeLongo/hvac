...
import type { CookiePrefs } from "@/lib/types/cookies";
    ...
    >
      <div className="space-y-4 text-white">
        ...
        <p>
          ...
          <a href="/privacy" className="hover:underline" style={{ color: "var(--cookie-accent)" }} onClick={onClose}>
            Privacy Policy
          </a>{" "}
          and{" "}
          <a href="/privacy#cookie-policy" className="hover:underline" style={{ color: "var(--cookie-accent)" }} onClick={onClose}>
            Cookie Policy
          </a>.
        </p>
